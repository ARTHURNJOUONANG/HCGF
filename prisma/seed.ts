...
const offres: {
  ...
  },
  {
    pays: "BE",
    service: "ASSURANCE",
    texte: "Assurance voyage pour une destination Belgique.",
    etapes: ["formulaire", "tarification", "paiement", "attestation"],
    champs: [
      ...champsIdentite(),
      { code: "date_debut", typeSaisie: "date", obligatoire: true, ordre: 10, libelle: "Début du séjour" },
  ...
  },
  {
    pays: "CA",
    service: "ASSURANCE",
    texte: "Assurance voyage pour une destination Canada.",
    etapes: ["formulaire", "tarification", "paiement", "attestation"],
    champs: [
      ...champsIdentite(),
      { code: "date_debut", typeSaisie: "date", obligatoire: true, ordre: 10, libelle: "Début du séjour" },
  ...
  },
  {
    pays: "FR",
    service: "VOL",
    texte: "Vol Hold Afrique ↔ France (CDG/ORY). Compagnies : Air France, Brussels Airlines, Royal Air Maroc…",
    etapes: ["recherche", "passager", "hold", "justificatif"],
    champs: [
      ...champsIdentite(),
      { code: "aeroport_depart", typeSaisie: "text", obligatoire: true, ordre: 10, libelle: "Aéroport / ville de départ", aide: "Afrique : DLA, NSI, ABJ, DSS, CMN, ALG… ou Douala, Dakar, Abidjan." },
      { code: "aeroport_arrivee", typeSaisie: "text", obligatoire: true, ordre: 11, libelle: "Aéroport / ville d'arrivée", aide: "France : CDG, ORY, LYS, MRS — ou Paris, Lyon, Marseille." },
  ...
  },
  {
    pays: "DE",
    service: "VOL",
    texte: "Vol Hold Afrique ↔ Allemagne (FRA, BER, MUC). Lufthansa, Ethiopian, EgyptAir…",
    etapes: ["recherche", "passager", "hold", "justificatif"],
    champs: [
      ...champsIdentite(),
      { code: "aeroport_depart", typeSaisie: "text", obligatoire: true, ordre: 10, libelle: "Aéroport / ville de départ", aide: "Ex. ADD, NBO, CAI, CMN, DLA…" },
      { code: "aeroport_arrivee", typeSaisie: "text", obligatoire: true, ordre: 11, libelle: "Aéroport / ville d'arrivée", aide: "Allemagne : FRA, BER, MUC — Francfort, Berlin, Munich." },
      { code: "date_depart", typeSaisie: "date", obligatoire: true, ordre: 12, libelle: "Date de départ" },
      { code: "date_retour", typeSaisie: "date", obligatoire: false, ordre: 13, libelle: "Date de retour (si aller-retour)" },
    ],
    pieces: [{ typePiece: "passeport", libelle: "Passeport / document de voyage", obligatoire: true, ordreFusion: 2 }],
  },
  {
    pays: "BE",
    service: "VOL",
    texte: "Vol Hold Afrique ↔ Belgique (BRU). Brussels Airlines, Air France…",
    etapes: ["recherche", "passager", "hold", "justificatif"],
    champs: [
      ...champsIdentite(),
      { code: "aeroport_depart", typeSaisie: "text", obligatoire: true, ordre: 10, libelle: "Aéroport / ville de départ", aide: "Ex. DLA, ABJ, DSS, FIH, LBV…" },
      { code: "aeroport_arrivee", typeSaisie: "text", obligatoire: true, ordre: 11, libelle: "Aéroport / ville d'arrivée", aide: "Belgique : BRU — Bruxelles." },
      { code: "date_depart", typeSaisie: "date", obligatoire: true, ordre: 12, libelle: "Date de départ" },
      { code: "date_retour", typeSaisie: "date", obligatoire: false, ordre: 13, libelle: "Date de retour (si aller-retour)" },
    ],
    pieces: [{ typePiece: "passeport", libelle: "Passeport / document de voyage", obligatoire: true, ordreFusion: 2 }],
  },
  {
    pays: "CA",
    service: "VOL",
    texte: "Vol Hold Afrique / Europe ↔ Canada (YUL, YYZ). Air Canada, Air France…",
    etapes: ["recherche", "passager", "hold", "justificatif"],
    champs: [
      ...champsIdentite(),
      { code: "aeroport_depart", typeSaisie: "text", obligatoire: true, ordre: 10, libelle: "Aéroport / ville de départ", aide: "Ex. DLA, DSS, CMN, CDG, BRU…" },
      { code: "aeroport_arrivee", typeSaisie: "text", obligatoire: true, ordre: 11, libelle: "Aéroport / ville d'arrivée", aide: "Canada : YUL, YYZ, YVR — Montréal, Toronto, Vancouver." },
      { code: "date_depart", typeSaisie: "date", obligatoire: true, ordre: 12, libelle: "Date de départ" },
      { code: "date_retour", typeSaisie: "date", obligatoire: false, ordre: 13, libelle: "Date de retour (si aller-retour)" },
    ],
    pieces: [{ typePiece: "passeport", libelle: "Passeport / document de voyage", obligatoire: true, ordreFusion: 2 }],
